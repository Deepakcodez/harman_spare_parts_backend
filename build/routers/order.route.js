...
router.post('/paymentVerify', auth_1.isAuthenticatedUser, order_controller_1.paymentVerify);
router.post('/razorpayorder', auth_1.isAuthenticatedUser, order_controller_1.createRazorpayOrder);
router.post('/cart/razorpayorder', auth_1.isAuthenticatedUser, order_controller_1.createRazorpayOrderOfCart);
